...
enum pinout{
  ...
  DEBUG_LED = 19,///< LED Output used for Sapflow Status, Debugging, and Error reporting
  KILL_SWITCH = 18,///< Switch used to kill circuit once battery goes below certain voltage.
};
